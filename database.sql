...
-- Dumping database structure for hardware_store
...
-- Dumping structure for table hardware_store.cart
...
-- Dumping structure for table hardware_store.categories
...
-- Dumping structure for table hardware_store.orders
...
-- Dumping structure for table hardware_store.order_items
...
-- Dumping structure for table hardware_store.products
...
-- Dumping structure for table hardware_store.users
