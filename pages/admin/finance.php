    ...
    <div class="finance-content">
        ...
        <div class="header-text">
            <div class="text-container">
                ...
                <p>View daily, weekly, and monthly finance report.</p>
            </div>
        </div>
                ...
                <div class="box">
                    <div class="box-inner">
                        ...
                        <h2 class="box-value">₱<?php
                            ...
                            $weekly_row = $weekly->fetch_assoc();

                            echo number_format($weekly_row['total'] ?? 0, 2);
                        ?></h2>
                ...
                <div class="box">
                    <div class="box-inner">
                        ...
                        <h2 class="box-value">₱<?php
                            ...
                            $monthly_row = $monthly->fetch_assoc();

                            echo number_format($monthly_row['total'] ?? 0, 2);
                        ?></h2>
