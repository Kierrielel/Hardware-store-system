...
<head>
    ...
    <!-- --------------------------------------------------
         LINKING CSS FILES (STYLING)
    -------------------------------------------------- -->
    <!-- These files control the design of different pages -->
    ...
    <!-- Google icons (used for search icon, etc.) -->
...
<body>
    <!-- --------------------------------------------------
         HEADER SECTION (TOP PART OF WEBSITE)
    -------------------------------------------------- -->
    <header>

        <!-- Top banner (logo + title + search bar) -->
        <div class="banner">
            ...
            <div class="search-con">
                ...
                <!-- Form sends search data using GET method -->
                <form action="/Hardware_Store_System/pages/customer/products.php" method="get">
                    ...
                    <div class="search-bar">
                        ...
                        <!-- Search input field -->
                        <!-- Keeps the previous search value using PHP -->
        ...
        <div class="banner-2">
            <nav>
                ...
                <div class="links-container">
                    ...
                    <!-- --------------------------------------------------
                         USER LOGIN / ACCOUNT DISPLAY
                    -------------------------------------------------- -->
                    <?php
                        // Check if user is logged in
                        if (isset($_SESSION['user'])): ?>   

                            <!-- If logged in: show account link with username -->
